                ...
                <div className="w-[30%] mt-14 flex flex-col justify-between maxXl:w-full maxXl:mt-4 maxXl:gap-8 maxMd:!mt-[-45px]">
                    ...
                    <div className="xl:flex maxXl:grid maxXl:grid-cols-2 maxMd:!grid-cols-1 gap-16 mt-7 maxXl:mt-0 h-full maxXl:gap-6 maxMd:text-center">
                        <div className="xl:!hidden p-6 rounded-lg shadow-cardShadow maxLg:!flex flex-col justify-end cardSmallArrow">
                            <h2 className="text-[33px] leading-10 font-ranika relative">subscribe <span className="text-[#EB4F55] text-6xl maxXl:text-3xl absolute right-[0] top-[-20px] font-ranika">1</span></h2>
                            <p className="mt-2">Select your ideal plan. Start hassle-free, no strings attached..</p>
                        </div>
                        <div className="xl:!hidden p-6 rounded-lg shadow-cardShadow maxLg:!flex flex-col justify-end cardSmallArrowRes">
                            <h2 className="text-[33px] leading-10 font-ranika relative">list tasks <span className="text-[#EB4F55] text-6xl maxXl:text-3xl absolute right-[0] top-[-20px] font-ranika">2</span></h2>
                            <p className="mt-2">Tell us what you need; we'll handle the rest. Pour out all your design needs.</p>

                        </div>
                        <div className="xl:!hidden p-6 rounded-lg shadow-cardShadow maxLg:!flex flex-col justify-end order-4 cardSmallLeftArrowRes">
                            <h2 className="text-[33px] leading-10 font-ranika relative">revise <span className="text-[#EB4F55] text-6xl maxXl:text-3xl absolute right-[0] top-[-20px] font-ranika">3</span></h2>
                            <p className="mt-2">Enjoy the freedom of unlimited revisions, ensuring each detail aligns with your vision.</p>

                        </div>
                        <div className="p-6 rounded-lg shadow-cardShadow flex flex-col justify-end maxXl:order-3 maxMd:!order-4 ">
                            <h2 className="text-[33px] leading-10 font-ranika relative">get <br /> delivery <span className="text-[#EB4F55] text-6xl maxXl:text-3xl absolute right-[0] top-[-20px] font-ranika">4</span></h2>
                            <p className="mt-2">Receive designs within 2-5 days or less ensuring your satisfaction with every delivery.</p>

                        </div>
                        <div className="social-icons maxXl:hidden">
                            <ul>
                                <li><a href="#"><img src={emailIocn} alt="email-icon" /></a></li>
                                <li><a href="#"><img src={instagramIocn} alt="instagram-icon" /></a></li>
                                <li><a href="#"><img src={facebookIocn} alt="facebook-icon" /></a></li>
                                <li><a href="#"><img src={linkdinIocn} alt="linkdin-icon" /></a></li>
                                <li><a href="#"><img src={xIocn} alt="twitter-icon" /></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
